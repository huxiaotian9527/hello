...
//    private static String myEmailSMTPHost = "smtp.qq.com";
    private static String myEmailSMTPHost = "10.109.16.21";

    private static int port = 25;
    //发件人邮箱
    private static String myEmailAccount = "csot.t4cimalarm@tcl.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "SPC_Alarm_Mail";//rkupunykyctwbdgb //uoowhtvzjepcbdjf
...
//        props.put("mail.smtp.ssl.socketFactory", sf);
    ...
    public static void main(String[] args) throws Exception{
        String toEmailAddress = "hutiantian@tcl.com";
        String emailTitle="测试邮件标题";
        String emailContent = "今天我在测试发右键，哈哈哈哈~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~";
